...
| Part Name and STL Link | Picture | Category | Quantity | Print type | Printer | Material | Print Notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| [Body Structure Bottom](https://drive.google.com/file/d/1TcWrUG80rmQFGoHcIazRVJeUTKyrpkcs/view?usp=sharing) | ![image](https://user-images.githubusercontent.com/57100380/119670459-e8d0a080-be06-11eb-9a0e-7c7d028d5711.png) | Body Structure | 1 | FDM/SLS | LULZBOT TAZ5 | IC3D ABS | Print this piece with a 10 degree ratation around the Y-axis to fit it on the TAZ 5 print bed.
