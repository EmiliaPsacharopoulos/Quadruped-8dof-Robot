...
| Cut 4 strips 7cm long of 28 AWG wire. Strip about 0.5cm off the one end of each wire, twisting the exposed wire after each strip.  | --- |
| Solder the four wires to the four headers. | --- |
